{
    ...
    'depends': ['web', 'mail', 'auth_oauth', 'auth_signup'],
    'data':[
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'bhuarjan/static/src/dashboard/css/timeline_component.css',
            'bhuarjan/static/src/dashboard/xml/dashboard_header.xml',
            'bhuarjan/static/src/dashboard/xml/timeline_component.xml',
            ...
            'bhuarjan/static/src/js/s23_preview_table_sort.js',
        ],
        'web.assets_frontend': [
            'bhuarjan/static/src/scss/password_eyes_icon.scss',
