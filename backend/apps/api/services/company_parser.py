# apps/api/services/company_parser.py
...
from .gemini import upload_file_to_gemini, generate_with_gemini
...
# ----------------------------
def _extract_from_single_pdf(company_name: str, pdf_path: str, model: str) -> Dict[str, Any]:
    """
    ...
    try:
        uploaded = upload_file_to_gemini(pdf_path)
...
def extract_company_bidder_and_payments(
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as ex:
        futures = [
            ex.submit(_extract_from_single_pdf, company_name, pdf_path, model)
