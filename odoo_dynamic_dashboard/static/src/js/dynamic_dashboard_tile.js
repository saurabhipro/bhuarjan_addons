...
DynamicDashboardTile.template = xml `
    <div class="resize-drag tile"
        ...
        t-att-style="this.props.widget.color+this.props.widget.text_color+ 'height:'+this.props.widget.height+';width:'+this.props.widget.width + ';top: '+ this.props.widget.translate_x +'; left: '+ this.props.widget.translate_y +'; '">
