{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'bhuarjan/static/src/css/admin_dashboard.css',
            'bhuarjan/static/src/js/sdm_dashboard.js',
            'bhuarjan/static/src/xml/sdm_dashboard.xml',
            'bhuarjan/static/src/js/admin_dashboard.js',
            'bhuarjan/static/src/xml/admin_dashboard.xml',
            'bhuarjan/static/src/js/web_client_dashboard.js',
