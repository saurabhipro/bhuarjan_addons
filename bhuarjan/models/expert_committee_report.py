...
class ExpertCommitteeReport(models.Model):
    ...
    _sql_constraints = [
        ('unique_project_id', 'unique(project_id)', 'Only one Expert Committee Report is allowed per project! / एक परियोजना के लिए केवल एक विशेषज्ञ समिति रिपोर्ट की अनुमति है!')
    ]
